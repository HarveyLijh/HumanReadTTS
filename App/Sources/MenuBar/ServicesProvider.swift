...
/// Exposes HumanReadTTS to the system Services menu. When the user picks
/// "Read with HumanReadTTS" from any app's Services submenu, macOS delivers
...
final class ServicesProvider: NSObject {
    @objc func readSelection(
        ...
        guard let text = pboard.string(forType: .string),
            ...
            error.pointee = "HumanReadTTS couldn't read the selection." as NSString
            return
        }
